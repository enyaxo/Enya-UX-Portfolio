        ...
        <div className='contact-container'>
            <div className='contact-details'>
                <div className={'section-contact'}>
                    <img src={Envelope} class={"contact-icon"} alt="Sparkle decoration"></img>
                    <h3>Email: <a href="mailto:enyabothabekker@gmail.com">enyabothabekker@gmail.com</a></h3>
                </div>
                <div className={'section-contact'}>
                    <img src={Phone} class={"contact-icon"} alt="Sparkle decoration"></img>
                    <h3>Phone: +64273193581</h3>
                </div>
                <div className={'section-contact'}>
                    <img src={LinkedIn} class={"contact-icon"} alt="Sparkle decoration"></img>
                    <h3>LinkedIn: <a href='https://www.linkedin.com/in/enya-bekker-55bb56373/' target="_blank">Enya Bekker</a></h3>
                </div>
                <div className={'section-contact'}>
                    <img src={Figma} class={"contact-icon"} alt="Sparkle decoration"></img>
