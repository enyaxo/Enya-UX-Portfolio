    ...
    <div className={'project-details-container'}>
      <div className={'heading-strip'}>
        ...
        <div className={'image-divider'}>
          <img alt={`Hero image for ${project.title}`} src={project.images.hero} />
        </div>
        ...
        <div className={'processes-content'}>
          ...
          <div className={'research-content'}>
            ...
            <div className={'research-box'}>
              <div style={{ display: 'inline' }}>
                ...
                {project.research_comment && (
                  <p className={'research-comment'}>{project.research_comment}</p>
                )}
              </div>
              {project.images.research && (
                <img alt={`Research image for ${project.title}`} src={project.images.research} />
              )}
            </div>
          </div>
          ...
          <div className={'prototype-content'}>
            ...
            <div className={'prototype-images'}>
              {project.images.prototype && (
                <img alt={`Prototype wireframes for ${project.title}`} src={project.images.prototype} />
              )}
            </div>
